...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>bakabröd.nu - Surdegskalkylator och brödguider</title>
        <link rel="canonical" href="https://bakabröd.nu" />
        <meta
          name="description"
          content="Beräkna exakta mängder mjöl, vatten och surdeg med vår gratis degkalkylator. Perfekt för hembakning av surdegsbröd med rätt hydreringsgrad."
        />
        <meta
          property="og:title"
          content="bakabröd.nu - Surdegskalkylator och brödguider"
        />
        <meta
          property="og:description"
          content="Beräkna exakta mängder mjöl, vatten och surdeg med vår gratis degkalkylator. Perfekt för hembakning av surdegsbröd."
        />
        <meta
          property="og:image"
          content="https://xn--bakabrd-f1a.nu/logo-bread.png"
        />
        <meta property="og:url" content="https://xn--bakabrd-f1a.nu/" />
        ...
        <meta
          ...
          content="Beräkna exakta mängder mjöl, vatten och surdeg med vår gratis degkalkylator."
        />
        <meta
          name="twitter:image"
          content="https://xn--bakabrd-f1a.nu/logo-bread.png"
