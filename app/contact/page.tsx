...
export const metadata: Metadata = {
  title: 'Om surdegskalkylatorn och kontakt',
  description:
    'Lär känna personen bakom surdegskalkylatorn på bakabröd.nu. Kontakta oss med frågor eller förslag på förbättringar.',
  alternates: {
    canonical: '/contact',
  },
  openGraph: {
    title: 'Om surdegskalkylatorn och kontakt',
    description:
      'Lär känna personen bakom surdegskalkylatorn på bakabröd.nu. Kontakta oss med frågor eller förslag.',
    url: '/contact',
  },
};
  ...
  return (
    <main className="container max-w-5xl mx-auto p-4">
      <article className="prose prose-sm md:prose-lg lg:prose-xl">
        <h1 className="text-secondary">Om surdegskalkylatorn</h1>
        <p>
          Surdegskalkylatorn är ett litet projekt som drivs av en glad
          utvecklare som också har ett stort intresse av att baka bröd med just
          surdeg.
        </p>
        <p>
        ...
        <p>
          ...
          experimentera med olika hydreringsgrader samt baka olika storlekar på
          bröden. Jag insåg då att det vore smidigt att ha en sida där man
